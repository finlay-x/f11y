    ...
    */
    f11y.Toast = class Toast {
        ...
        openToast(templateString, customToastTemplate = null) {
            ...
            toast.querySelector('[f11y-toast-close]').addEventListener('click', this.dismissToast.bind(this, toast.id));
        ...
        #createToast(template, templateString) {
            ...
            if (toastTemplate.hasAttributes()) {
                for(let i = 0; i < toastTemplate.attributes.length; i++){
                    if(toastTemplate.attributes[i].name === 'id') continue;
        ...
        updateToasts(){
            ...
            this.activeToasts.slice().reverse().forEach(function(toast) { // This shit is dumb
        ...
        #checkSwiping(event, yPos, xPos){
            ...
            switch(dir){
                case 'up':
                    ...
                    if(clamp < threshold) return true;
                    break;
                case 'down':
