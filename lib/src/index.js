 ...
 * @property {boolean} awaitOpenAnimation - Should components globally await opening CSS animations
 * @property {boolean} awaitCloseAnimation - Should components globally await closing CSS animations
...
f11y.Accordion = class Accordion {
     ...
     * @property {Element|null} item - The item element
     * @property {Element|null} panel - The panel element within the item
     * @property {Element|null} trigger - The trigger element within the item
     * @property {string|null} isOpen - Is the item open?
     */
...
f11y.Layer = class Layer {
    ...
    destroy(){
        ...
        this.domNode.classList.remove('has-initialised');
        for (let i = 0; i < this.triggerElms.length; i++) {
